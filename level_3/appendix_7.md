...
![Sorting circuit.](images/appendices/appendix_7/sorter-first_circuit.png)
...
> If a comparator is placed next to a container, it will provide an output based on the percentage of used space in the container. [link](http://minecraft.gamepedia.com/Redstone_Comparator)
...
![Sorting circuit.](images/appendices/appendix_7/sorter-testing_hopper.png)
...
![Second sorting circuit.](images/appendices/appendix_7/sorter-second_circuit_one.png)

![Another view of the second sorting circuit.](images/appendices/appendix_7/sorter-second_circuit_two.png)
